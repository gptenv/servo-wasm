...
The current ABI 7 production-stripped artifact, built with locked dependencies from mozjs-wasm `f942001b4`, is **62,845,917 bytes** (about 59.9 MiB), SHA-256 `802352e5a153c516831fc20095e2ebb49fe3ba1556072519bce450d8001d72fa`; the local Wrangler 4.136.3 dry run bundled 61,434.90 KiB of Worker JavaScript and WASM, below the 64 MiB limit. The Worker imports exactly five `env` functions, with no WASI or wasm-bindgen imports:
